...
<script src="../Javascript/toDoListAdder.js"></script>
</body>
</html>
...
if ($_SERVER['REQUEST_METHOD'] == "GET" and !empty($_SESSION['login_user'])) {
    ...
    if (!empty($heading)) {
        $query = "INSERT INTO todo(username, heading, addnInfo, date) VALUES('$username','$heading','$addnInfo','$date')";
...
if (!empty($_SESSION['login_user'])) {
    ...
    while ($length >= 0) {
        ...
        "<script>
            ...
            deleteForm.action = '../PHP/deleteEntryFromToDo.php';
